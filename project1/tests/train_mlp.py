"""
MLP Baseline for Forex Prediction - Single Label Version
==========================================================================
...
def plot_results(train_results, val_results, test_results, output_dir):
    ...
    # Save plot
    plot_path = os.path.join(output_dir, 'mlp_results.png')
...
def main():
    parser = argparse.ArgumentParser(
        description='Train MLP for Binary Forex Prediction'
    )
    ...
    print("="*60)
    print("MLP - FOREX BINARY PREDICTION")
    print("="*60)
    ...
    model_path = os.path.join(args.output_dir, 'mlp_model.joblib')
    ...
    with open(results_file, 'w') as f:
        f.write("NEURAL NETWORK - BINARY FOREX PREDICTION\n")
        f.write("="*60 + "\n")
